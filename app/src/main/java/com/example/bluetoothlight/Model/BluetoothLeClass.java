...
public class BluetoothLeClass extends Service {
    private final static String TAG = "BluetoothLeClass";//BluetoothLeClass.class.getSimpleName();做测试用
    ...
    public BluetoothGatt mBluetoothGatt;//蓝牙主机
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            LogUtil.w(TAG, "BluetoothLeClass.onCharacteristicChanged");
            if (mOnDataAvailableListener != null) {
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            LogUtil.i(TAG, "--onReadRemoteRssi--: " + status + ",   rssi:" + rssi + "-----------------------");
    ...
    public boolean initialize() {
        ...
        //利用取得的BluetoothManager通过getAdapter取得BluetoothAdapter
    ...
    public void updateRssiBroadcast(int rssi) {
        LogUtil.i(TAG, "updateRssiBroadcast1 " + rssi);
    ...
    public boolean connect(final String address) {
        ...
        //若BluetoothAdapter为空或设备地址为空
        if (mBluetoothAdapter == null || address == null) {
            LogUtil.w(TAG, "BluetoothAdapter not initialized or unspecified address.");
            return false;
        }

        //之前连接过的设备，尝试重连，Previously connected device. Try to reconnect.
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled) {
        ...
        if (enabled == true) {
            LogUtil.i(TAG, "Enable Notification");
            ...
            LogUtil.i(TAG, "Disable Notification");
    ...
    //判断是否存在非空的mBluetoothAdapter,或mBluetoothGatt
